...
const SKILLS = [
  ...
  { name: "Maven", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/maven/maven-original-wordmark.svg" },
  { name: "JPA-Hibernate", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/hibernate/hibernate-original.svg" },
];
...
const ROWS = [
  [
    ...
    { title: "Frameworks & Libraries", items: ["React.Js", "Node.Js", "Spring Boot"] },
  ],
  [
    {
      title: "Core Concepts",
